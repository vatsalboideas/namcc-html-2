...
$(document).ready(function () {
  // Optional: Mute toggle logic
  try {
    const playerEl = document.getElementById("my-video-showreel-video");
    const muteToggle = document.getElementById("mute-toggle");

    if (playerEl && typeof videojs !== "undefined") {
      const player = videojs("my-video-showreel-video");
    ...
    console.warn("Mute toggle setup skipped due to error:", e);
  }
